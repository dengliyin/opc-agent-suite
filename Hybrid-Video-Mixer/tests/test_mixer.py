...
class MixerTests(unittest.TestCase):
    ...
    def test_ui_exposes_single_subtitle_checkbox_and_match_summary(self):
        ...
        self.assertIn('planPhase: "idle"', javascript)
        self.assertIn('state.planPhase = "running"', javascript)
        self.assertIn('state.planPhase = "ready"', javascript)
        self.assertIn('state.planPhase = "error"', javascript)
        self.assertIn('正在生成方案（${availableHookCount} 条）', javascript)
        self.assertIn('现在可以点击“确认并渲染”', javascript)

...
AGENT_SERVICE_IDS=(collect analyze script adapt assemble finished rewrite compose hybrid_adapt hybrid_mix hybrid_collect hybrid_analyze hybrid_script hybrid_voice auto_publish)
...
urls = [
    ...
    os.getenv('OPC_HYBRID_VIDEO_MIXER_AGENT_URL', 'http://127.0.0.1:10000/'),
    ...
    os.getenv('OPC_HYBRID_AUDIO_GENERATION_AGENT_URL', 'http://127.0.0.1:10004/'),
    os.getenv('OPC_AUTO_PUBLISH_PIPELINE_URL', 'http://127.0.0.1:10005/'),
]

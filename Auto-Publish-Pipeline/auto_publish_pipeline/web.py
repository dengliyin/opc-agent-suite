...
<body><main><header><div><h1>10005 · 自动发布流水线</h1><p>独立完成脚本裂变、适配、片段产出、合成与串行发布，不要求9993–9995处于启动状态。</p></div><div class="actions"><button id="scanCatalog">扫描资料库</button><a href="http://127.0.0.1:8888/">返回集合控制台</a></div></header>
